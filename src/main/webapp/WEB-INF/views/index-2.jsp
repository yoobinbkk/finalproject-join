...
<html class="no-js" lang="zxx">
   ...
   <body>
      ...
      <main>
               ...
               <div class="row">
                  <div class="col-xxl-6 offset-xxl-3 col-xl-6 offset-xl-3">
                     <div class="section__title-wrapper section-padding mb-60 text-center">
                        <h2 class="section__title">Why an <span class="yellow-bg">scholercity <img src="assets/img/shape/yellow-bg-2.png" alt=""></span> out of The ordinary</h2>
               ...
               <div class="row">
                  <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                     <div class="services__item blue-bg-4 mb-30">
                        ...
                        <div class="services__content">
                           <h3 class="services__title"><a href="about">4,000 <br> Online courses</a></h3>
                  ...
                  <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                     <div class="services__item pink-bg mb-30">
                        ...
                        <div class="services__content">
                           <h3 class="services__title"><a href="about">Job placement<br> Support</a></h3>
                           <p>Arse over tit morish wind up gormless butty.!</p>
                  ...
                  <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                     <div class="services__item purple-bg mb-30">
                        ...
                        <div class="services__content">
                           <h3 class="services__title"><a href="about">Lifetime<br> Slack chat support</a></h3>
                           <p>Arse over tit morish wind up gormless butty.!</p>
                  ...
                  <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                     <div class="services__item green-bg mb-30">
                        ...
                        <div class="services__content">
                           <h3 class="services__title"><a href="about">Research<br>  and Innovation</a></h3>
                           <p>Arse over tit morish wind up gormless butty.!</p>
         ...
         <section class="testimonial__area testimonial__overlay pt-175 pb-170" data-background="assets/img/testimonial/testimonial-bg.jpg">
            <div class="container">
